...
pub async fn strauss_shamir_mul() {
    ...
    for log_limb_size in 13..14 {
        for _ in 0..NUM_RUNS_PER_TEST {
            ...
            let b = coords::ETEProjective::<Fq> { x: b.x, y: b.y, t: b.t, z: b.z };

            do_strauss_shamir_mul_test(&a, &b, &x, &y, projective_to_affine_func, log_limb_size, "ed25519_curve_strauss_shamir_mul_tests.wgsl", "test_strauss_shamir_mul").await;
        }
    }
}
