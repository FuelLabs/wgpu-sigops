...
@compute
@workgroup_size(256)
fn benchmark_secp256r1_recover(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    var recovered = secp256r1_ecrecover(&r_bytes_be, &s_bytes_be, &msg_bytes_be, &p_bigint, &p_wide, &scalar_p, &scalar_p_wide, &r, &rinv, &mu_fp, &mu_fr);
